...
class GrupoViajeModel {
  ...
  final bool puedeExplorar;
  final bool puedePriorizar;
  final int? faltanExploracion;
  final int? faltanPriorizacion;
  ...
  GrupoViajeModel({
    ...
    this.usuarioActualExploro = false,
    this.usuarioActualPriorizo = false,
    this.puedeExplorar = false,
    this.puedePriorizar = false,
    this.faltanExploracion,
    this.faltanPriorizacion,
  ...
  factory GrupoViajeModel.fromJson(Map<String, dynamic> json) {
    return GrupoViajeModel(
      ...
      itinerarioId: (json['itinerarioId'] as num?)?.toInt(),
      ...
      usuarioActualPriorizo: json['usuarioActualPriorizo'] == true,
      puedeExplorar: json['puedeExplorar'] == true,
      puedePriorizar: json['puedePriorizar'] == true,
      faltanExploracion: (json['faltanExploracion'] as num?)?.toInt(),
      faltanPriorizacion: (json['faltanPriorizacion'] as num?)?.toInt(),
    );
  }
}
